...
public class StatisticsView extends JFrame implements ActionListener {
	...
	private String[] statLabels = { "Creatures", "Avg. Life",  "Avg. Max Life", "Avg. Energy", "Avg. Max Energy", 
			"Avg. Speed", "Avg. Vision Range", "Avg. Mating Energy Needed", "Avg. Breed Length", "Avg. Breed Progress Speed", 
			"Gender Ratio", "Pregnancy Ratio"};

	private Color[] statColors = { new Color(255, 85, 85), new Color(85, 85, 255), new Color(85, 255, 85), 
			new Color(255, 255, 85), new Color(255, 85, 255), new Color(85, 255, 255), new Color(255, 175, 175), 
			new Color(128, 128, 128), new Color(192, 0, 0), new Color(0, 0, 192), new Color(0, 192, 0), new Color(192, 164, 0)};
	...
	private JFreeChart createChart(final XYDataset dataset, Vector<Color> colors) {
		...
		for (int k = 0; k < colors.size(); k++) {
			plot.getRenderer().setSeriesPaint(k, colors.elementAt(k));
		}
